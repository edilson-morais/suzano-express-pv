        ...
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="text-center space-y-8">
            ...
            <h2 className="text-3xl md:text-5xl font-bold">
              Por que você precisa da Comunidade Cr[IA]dores da Nova Era agora:
            </h2>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {reasons.map((reason, index) => (
              <Card key={index} className="p-6 space-y-4 border-l-4 border-l-primary hover:shadow-glow-cyan transition-smooth">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              {targetAudience.map((audience, index) => (
                <Card key={index} className="p-6 border-primary/30 bg-gradient-primary/5">
              ...
              <div className="flex items-center justify-center space-x-4">
                <div className="flex -space-x-2">
                  {[...Array(8)].map((_, i) => (
                    <div 
                      key={i} 
                      className="w-10 h-10 rounded-full bg-gradient-primary border-2 border-background flex items-center justify-center text-primary-foreground font-bold text-sm"
                    >
